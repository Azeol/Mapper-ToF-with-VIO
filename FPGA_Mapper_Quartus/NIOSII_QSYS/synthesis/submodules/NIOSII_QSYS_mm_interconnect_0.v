// NIOSII_QSYS_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module NIOSII_QSYS_mm_interconnect_0 (
	...
	wire  [96:0] cmd_mux_008_src_data;                                                             // cmd_mux_008:src_data -> UART_s1_agent:cp_data
	...
	wire         cmd_mux_009_src_valid;                                                            // cmd_mux_009:src_valid -> TIMER_MAIN_s1_agent:cp_valid
	wire  [96:0] cmd_mux_009_src_data;                                                             // cmd_mux_009:src_data -> TIMER_MAIN_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                            // TIMER_MAIN_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [10:0] cmd_mux_009_src_channel;                                                          // cmd_mux_009:src_channel -> TIMER_MAIN_s1_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                                    // cmd_mux_009:src_startofpacket -> TIMER_MAIN_s1_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                                      // cmd_mux_009:src_endofpacket -> TIMER_MAIN_s1_agent:cp_endofpacket
	...
	wire  [96:0] cmd_mux_010_src_data;                                                             // cmd_mux_010:src_data -> HEX3_HEX0_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                            // HEX3_HEX0_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [10:0] cmd_mux_010_src_channel;                                                          // cmd_mux_010:src_channel -> HEX3_HEX0_s1_agent:cp_channel
	...
	wire  [96:0] uart_s1_agent_rp_data;                                                            // UART_s1_agent:rp_data -> router_010:sink_data
	...
	wire         timer_main_s1_agent_rp_valid;                                                     // TIMER_MAIN_s1_agent:rp_valid -> router_011:sink_valid
	wire  [96:0] timer_main_s1_agent_rp_data;                                                      // TIMER_MAIN_s1_agent:rp_data -> router_011:sink_data
	wire         timer_main_s1_agent_rp_ready;                                                     // router_011:sink_ready -> TIMER_MAIN_s1_agent:rp_ready
	wire         timer_main_s1_agent_rp_startofpacket;                                             // TIMER_MAIN_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire         timer_main_s1_agent_rp_endofpacket;                                               // TIMER_MAIN_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire  [96:0] hex3_hex0_s1_agent_rp_data;                                                       // HEX3_HEX0_s1_agent:rp_data -> router_012:sink_data
	...
	wire         timer_main_s1_agent_rdata_fifo_src_valid;                                         // TIMER_MAIN_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] timer_main_s1_agent_rdata_fifo_src_data;                                          // TIMER_MAIN_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire         timer_main_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_009:in_0_ready -> TIMER_MAIN_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_009_out_0_valid;                                                // avalon_st_adapter_009:out_0_valid -> TIMER_MAIN_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                                 // avalon_st_adapter_009:out_0_data -> TIMER_MAIN_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                                // TIMER_MAIN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                                // avalon_st_adapter_009:out_0_error -> TIMER_MAIN_s1_agent:rdata_fifo_sink_error
	...
	NIOSII_QSYS_mm_interconnect_0_router router (
	...
	NIOSII_QSYS_mm_interconnect_0_router_001 router_001 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_002 router_002 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_002 router_003 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_002 router_004 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_005 router_005 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_005 router_006 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_002 router_007 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_002 router_008 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_002 router_009 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_002 router_010 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_002 router_011 (
	...
	NIOSII_QSYS_mm_interconnect_0_router_002 router_012 (
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                               //        clk.clk
		.reset              (NIOSII_CPU_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_cmd_mux cmd_mux_010 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_demux rsp_demux_010 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                  (clk_0_clk_clk),                                //       clk.clk
		.reset                (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOSII_QSYS_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
