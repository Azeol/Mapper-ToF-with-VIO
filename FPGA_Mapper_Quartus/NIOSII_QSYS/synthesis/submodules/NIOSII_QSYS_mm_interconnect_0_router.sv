...
module NIOSII_QSYS_mm_interconnect_0_router_default_decode
  #(
...
module NIOSII_QSYS_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD9 = log2ceil(64'h410c8 - 64'h410c0); 
    localparam PAD10 = log2ceil(64'h410d0 - 64'h410c8); 
    // -------------------------------------------------------
    ...
    NIOSII_QSYS_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x410c8 .. 0x410d0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 19'h410c8  && read_transaction  ) begin
