...
module Hardware_Qsys_mm_interconnect_0_router_default_decode
  #(
...
module Hardware_Qsys_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD12 = log2ceil(64'h41118 - 64'h41110); 
    localparam PAD13 = log2ceil(64'h41120 - 64'h41118); 
    // -------------------------------------------------------
    ...
    Hardware_Qsys_mm_interconnect_0_router_default_decode the_default_decode(
    ...
    // ( 0x41100 .. 0x41110 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 19'h41100  && read_transaction  ) begin
    ...
    // ( 0x41118 .. 0x41120 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 19'h41118   ) begin
