...
module Hardware_Qsys_mm_interconnect_0 (
	...
	wire   [9:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> NIOSII_CPU_data_master_agent:rp_channel
	...
	wire   [9:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> NIOSII_CPU_debug_mem_slave_agent:cp_channel
	...
	wire         cmd_mux_004_src_valid;                                                            // cmd_mux_004:src_valid -> TIMER_MAIN_s1_agent:cp_valid
	wire  [96:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> TIMER_MAIN_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                            // TIMER_MAIN_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [9:0] cmd_mux_004_src_channel;                                                          // cmd_mux_004:src_channel -> TIMER_MAIN_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                    // cmd_mux_004:src_startofpacket -> TIMER_MAIN_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                      // cmd_mux_004:src_endofpacket -> TIMER_MAIN_s1_agent:cp_endofpacket
	...
	wire   [9:0] cmd_mux_006_src_channel;                                                          // cmd_mux_006:src_channel -> PB_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_008_src_channel;                                                          // cmd_mux_008:src_channel -> HEX3_HEX0_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_009_src_data;                                                             // cmd_mux_009:src_data -> HEX5_HEX4_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                            // HEX5_HEX4_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [9:0] cmd_mux_009_src_channel;                                                          // cmd_mux_009:src_channel -> HEX5_HEX4_s1_agent:cp_channel
	...
	wire         timer_main_s1_agent_rp_valid;                                                     // TIMER_MAIN_s1_agent:rp_valid -> router_006:sink_valid
	wire  [96:0] timer_main_s1_agent_rp_data;                                                      // TIMER_MAIN_s1_agent:rp_data -> router_006:sink_data
	wire         timer_main_s1_agent_rp_ready;                                                     // router_006:sink_ready -> TIMER_MAIN_s1_agent:rp_ready
	wire         timer_main_s1_agent_rp_startofpacket;                                             // TIMER_MAIN_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         timer_main_s1_agent_rp_endofpacket;                                               // TIMER_MAIN_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [96:0] hex5_hex4_s1_agent_rp_data;                                                       // HEX5_HEX4_s1_agent:rp_data -> router_011:sink_data
	...
	wire   [9:0] router_001_src_channel;                                                           // router_001:src_channel -> NIOSII_CPU_instruction_master_limiter:cmd_sink_channel
	...
	wire   [9:0] niosii_cpu_instruction_master_limiter_cmd_src_channel;                            // NIOSII_CPU_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire   [9:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> NIOSII_CPU_instruction_master_limiter:rsp_sink_channel
	...
	wire   [9:0] niosii_cpu_instruction_master_limiter_rsp_src_channel;                            // NIOSII_CPU_instruction_master_limiter:rsp_src_channel -> NIOSII_CPU_instruction_master_agent:rp_channel
	...
	wire   [9:0] niosii_cpu_instruction_master_limiter_cmd_valid_data;                             // NIOSII_CPU_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire         timer_main_s1_agent_rdata_fifo_src_valid;                                         // TIMER_MAIN_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] timer_main_s1_agent_rdata_fifo_src_data;                                          // TIMER_MAIN_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         timer_main_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_004:in_0_ready -> TIMER_MAIN_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                // avalon_st_adapter_004:out_0_valid -> TIMER_MAIN_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                 // avalon_st_adapter_004:out_0_data -> TIMER_MAIN_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                // TIMER_MAIN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                // avalon_st_adapter_004:out_0_error -> TIMER_MAIN_s1_agent:rdata_fifo_sink_error
	...
	Hardware_Qsys_mm_interconnect_0_router_004 router_004 (
	...
	Hardware_Qsys_mm_interconnect_0_router_004 router_005 (
	...
	Hardware_Qsys_mm_interconnect_0_router_002 router_006 (
	...
	Hardware_Qsys_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardware_Qsys_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardware_Qsys_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardware_Qsys_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardware_Qsys_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (NIOSII_CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Hardware_Qsys_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
