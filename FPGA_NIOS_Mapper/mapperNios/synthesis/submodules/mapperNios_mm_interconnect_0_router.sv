...
module mapperNios_mm_interconnect_0_router_default_decode
  #(
...
module mapperNios_mm_interconnect_0_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    mapperNios_mm_interconnect_0_router_default_decode the_default_decode(
